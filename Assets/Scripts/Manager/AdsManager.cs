...
public class AdsManager
{
	...
	// 실제 출시용 ID들
	const string ANDROID_APP_ID = "ca-app-pub-3662579670065314~7495506471";
	const string ANDROID_INTERSTITIAL = "ca-app-pub-3662579670065314/1636104313";
	const string ANDROID_REWARDED = "ca-app-pub-3662579670065314/1086816695";
	const string IOS_APP_ID = "";

	public void PrepareAds()
	{
#if UNITY_ANDROID
		string interstitial = ANDROID_INTERSTITIAL; // Android_Interstitial
		string rewarded = ANDROID_REWARDED; // Android_Rewarded
